...
namespace VideoApp.Services
{
    public class AzureCloudService : ICloudService
    {
        ...
        {
            client = new MobileServiceClient(Constants.AppServiceUrl, new AuthenticationDelegatingHandler());

            if (Constants.AlternateLoginHost != null)
                client.AlternateLoginHost = new Uri(Constants.AlternateLoginHost);
        }
